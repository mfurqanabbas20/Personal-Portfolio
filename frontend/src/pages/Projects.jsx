    ...
    return(
        <div className="w-96 text-white font-poppins flex flex-col gap-1">
          <div className="image-container relative w-full group">
            ...
            <a target='_blank' className='text-white absolute top-5/12 left-5/12 bg-blue-500 p-2 cursor-pointer opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-md' href={link}><i className="fa-solid fa-arrow-up-right-from-square"></i>&nbsp;&nbsp;Link</a>
          </div>
